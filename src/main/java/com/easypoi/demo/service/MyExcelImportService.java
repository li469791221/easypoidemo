...
/**
 *
 * 自定义的导入服务，修改saveImage方法，导入时保存图片到fastdfs服务器
 * Excel 导入服务
 *
 * @author JueYue 2014年6月26日 下午9:20:51
 */
@SuppressWarnings({"rawtypes", "unchecked", "hiding"})
public class MyExcelImportService extends ImportBaseService {
    ...
    public MyExcelImportService(ExcelService excelService) {
        this();
...
//                    getSaveUrl(excelParams.get(titleString), object) + File.separator + fileName);
            ...
            MockMultipartFile file =
                    new MockMultipartFile(fileName, "test.jpg",
                            ContentType.WILDCARD.toString(), data);
